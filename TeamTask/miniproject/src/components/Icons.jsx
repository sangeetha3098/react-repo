...
export const KeyIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 7a2 2 0 012 2m-2 2a2 2 0 01-2-2m2-2a2 2 0 11-4 0m8 8v5a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2a2 2 0 00-.586-1.414l-4.586-4.586A2 2 0 015 10.828V8a2 2 0 012-2h3" />
  </svg>
);
